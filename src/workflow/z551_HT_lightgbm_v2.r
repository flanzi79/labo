...
PARAM$bo_lgb <- makeParamSet( 
         ...
         makeNumericParam("min_gain_to_split",lower=    0.0,  upper= 0.15),  # min_gain_to_split >= 0.0
         makeIntegerParam("lambda_l1",        lower=    0L,   upper=  100L), # lambda_l1 >= 0.0
         makeIntegerParam("lambda_l2",        lower=    0L,   upper=  100L)  # lambda_l2 >= 0.0
        )
