...
#valores posibles  "ninguno" "rank_simple" , "rank_cero_fijo" , "deflacion" , "rank_cero_abs"
PARAM$metodo  <- "rank_cero_abs"
...
#------------------------------------------------------------------------------
drift_rank_cero_abs  <- function( campos_drift )
{
  for( campo in campos_drift )
  {
    cat( campo, " " )
...
PARAM$metodo,
  ...
  "rank_cero_abs"  =drift_rank_cero_abs( campos_monetarios )
)
